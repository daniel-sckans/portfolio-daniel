...
const Testimonial = ({
  ...
  const sectionHeader = {
    title: 'The Baller Report',
    paragraph: '"This guy... is the best."'
  };
          ...
          <div className={tilesClasses}>
              ...
              <div className="tiles-item-inner">
                <div className="testimonial-item-content">
                  <p className="text-sm mb-0">
                    Kanakuk Kamps was glad to have Daniel work for us this summer
                      </p>
                </div>
            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                <div className="testimonial-item-content">
                  <p className="text-sm mb-0">
                    He is an absolute unit on the basketball court
                      </p>
                </div>
                <div className="testimonial-item-footer text-xs mt-32 mb-0 has-top-divider">
            ...
            <div className="tiles-item reveal-from-left" data-reveal-delay="200">
              <div className="tiles-item-inner">
                <div className="testimonial-item-content">
                  <p className="text-sm mb-0">
                    He do be a swell chap if I do say so me-self
                      </p>
                </div>
                <div className="testimonial-item-footer text-xs mt-32 mb-0 has-top-divider">
